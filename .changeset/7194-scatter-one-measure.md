...
the series keys it was handed. A single-series scatter is unchanged. This applies
to a `compareTo` overlay too — it is a second series, and it was painted at the
primary's y values by the same mechanism.
