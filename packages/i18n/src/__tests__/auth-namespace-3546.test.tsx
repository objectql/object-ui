...
describe('objectui#3546 slice three — the auth / oauth / acceptInvitation namespaces', () => {
  ...
  it('the ratchet actually shrank — no auth-family key is still baselined', () => {
    ...
    // 163 before this slice, 54 removed. The other namespaces' debt is not this
    ...
    // Untouched on purpose: none of the four remaining template-key FAMILIES
    // belongs to the auth family, so all four stay. This assertion is what
    // stops a later slice from thinking one was already handled here.
