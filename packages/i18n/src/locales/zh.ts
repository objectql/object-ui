...
const zh = {
  ...
  detail: {
    ...
    writeStrippedTitle: '部分字段未保存',
    writeStrippedReadonly: '以下字段为只读，未保存：{{fields}}',
    writeStrippedByState: '以下字段在记录当前状态下不可编辑，未保存：{{fields}}',
    inApprovalEditable: '审批中（可编辑）',
    inApprovalEditableTooltip: '该记录有待审批的请求，但当前审批节点未锁定记录，仍可编辑',
    cancelApproval: '撤回审批',
