const de = {
  ...
  grid: {
    ...
    import: {
      ...
      uploadDescription: "Laden Sie eine CSV-Datei hoch, um zu beginnen.",
      mappingDescription: "Ordnen Sie CSV-Spalten den Objektfeldern zu.",
      previewDescription: "Daten vor dem Import prüfen.",
      dragDrop: "CSV-Datei hierher ziehen oder klicken zum Durchsuchen",
