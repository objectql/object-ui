...
const en = {
  ...
  console: {
    ...
    datasource: {
      title: 'Datasources',
      subtitle: 'Connect external databases and sync their tables in as objects.',
      refresh: 'Refresh',
      new: 'New datasource',
      loading: 'Loading…',
      emptyPrefix: 'No datasources yet. Click ',
      emptyAction: 'New datasource',
      emptySuffix: ' to connect one.',
      confirmDelete: 'Delete datasource “{{name}}”? This cannot be undone.',
      row: {
        test: 'Test',
        sync: 'Sync objects',
        edit: 'Edit',
      ...
      editor: {
        editTitle: 'Edit “{{name}}”',
        newTitle: 'New datasource',
        editDesc: 'Update the connection. Leave the credential blank to keep the current one.',
        newDesc: 'Connect an external database. Credentials are encrypted and never stored in metadata.',
        name: 'Name',
        namePlaceholder: 'my_database',
        nameInvalid: 'Lowercase letters, digits, and underscores; must not start with a digit.',
        label: 'Label',
        labelPlaceholder: 'Human-friendly name',
        driver: 'Driver',
        driverPlaceholder: 'Choose a driver',
        schemaMode: 'Schema mode',
        // Keyed by the SCHEMA_MODES value.
        schemaModes: {
          managed: 'Managed (ObjectStack owns the schema)',
          external: 'External (read existing schema as-is)',
      ...
      sync: {
        title: 'Sync objects from “{{name}}”',
        desc: 'Pick the remote tables to import as objects. Each becomes an object definition.',
        introspecting: 'Introspecting…',
        noTables: 'No remote tables found on this datasource.',
        cols: '{{n}} cols',
        cancel: 'Cancel',
        create: 'Create {{n}} objects',
      },
      toast: {
        loadFailed: 'Load datasources: {{msg}}',
        testOk: '{{name}}: connection ok',
        testOkMs: '{{name}}: connection ok ({{ms}}ms)',
        testResult: '{{name}}: {{result}}',
        failed: 'failed',
        deleted: 'Deleted {{name}}.',
        deleteFailed: 'Delete {{name}}: {{msg}}',
        loadDrivers: 'Load drivers: {{msg}}',
        openFailed: 'Open {{name}}: {{msg}}',
        updated: 'Updated {{name}}.',
        created: 'Created {{name}}.',
        saveFailed: 'Save: {{msg}}',
        introspectFailed: 'Introspect {{name}}: {{msg}}',
        synced: 'Synced {{n}} objects from {{name}}.',
        syncFailed: 'Failed: {{errors}}',
      },
    },
    cloudConnection: {
      ...
      waitingPopup: 'Approve the connection in the window that just opened — this page updates by itself.',
      waitingConsole: 'Waiting for approval in the cloud console…',
      openApproval: 'Open the approval page',
      copy: 'Copy',
      copied: 'Copied',
      codePrefilled: 'The code is pre-filled on the approval page',
      ifNoWindow: '— if the window did not appear,',
      openItHere: 'open it here',
      endPunct: '.',
      cancel: 'Cancel',
      connectedTitle: 'Connected to ObjectStack Cloud',
      fields: {
        runtime: 'Runtime',
      ...
      boundNote: 'Your organization\'s private packages now appear in the Marketplace under “Your organization”.',
      disconnect: 'Disconnect',
      notConnected: 'Not connected',
      connectDesc:
        'Connect this runtime to an ObjectStack control plane to browse your organization\'s private packages and install them here. Approval is a single click in your cloud account — no ids or credentials are typed into this page.',
      connect: 'Connect',
    },
    loadingSteps: {
