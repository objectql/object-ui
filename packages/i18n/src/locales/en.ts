...
const en = {
  ...
  detail: {
    ...
    writeStrippedTitle: 'Some fields were not saved',
    writeStrippedReadonly: 'Read-only, so it was not saved: {{fields}}',
    writeStrippedByState: "Not editable in this record's current state, so it was not saved: {{fields}}",
    inApprovalEditable: 'In approval (editable)',
    inApprovalEditableTooltip: 'This record has a pending approval request, but this step does not lock it — you can still edit',
