const fr = {
  ...
  grid: {
    ...
    import: {
      ...
      stepPreview: "Aperçu",
      uploadDescription: "Téléchargez un fichier CSV pour commencer.",
      mappingDescription: "Faites correspondre les colonnes CSV aux champs de l'objet.",
      previewDescription: "Vérifiez les données avant d'importer.",
      dragDrop: "Faites glisser le fichier CSV ici ou cliquez pour parcourir",
      browseFiles: "Parcourir les fichiers",
      onlyCsv: "Seuls les fichiers CSV sont pris en charge.",
