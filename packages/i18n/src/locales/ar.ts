const ar = {
  ...
  detail: {
    ...
    inApprovalEditable: "قيد الموافقة (قابل للتعديل)",
    inApprovalEditableTooltip: "يحتوي هذا السجل على طلب موافقة معلق، لكن هذه الخطوة لا تقفله — لا يزال بإمكانك التعديل",
