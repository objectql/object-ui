const ar = {
  ...
  grid: {
    ...
    import: {
      ...
      stepMapping: "تعيين",
      stepPreview: "معاينة",
      uploadDescription: "ارفع ملف CSV للبدء.",
      mappingDescription: "عيّن أعمدة CSV إلى حقول الكائن.",
      previewDescription: "راجع البيانات قبل الاستيراد.",
      dragDrop: "اسحب ملف CSV هنا أو انقر للتصفح",
      browseFiles: "تصفح الملفات",
      onlyCsv: "ملفات CSV فقط مدعومة.",
