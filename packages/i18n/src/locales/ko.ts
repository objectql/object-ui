const ko = {
  ...
  detail: {
    ...
    inApprovalEditable: "승인 중(편집 가능)",
    inApprovalEditableTooltip: "이 레코드에 대기 중인 승인 요청이 있지만 이 단계는 레코드를 잠그지 않습니다. 계속 편집할 수 있습니다",
    writeStrippedTitle: "일부 필드가 저장되지 않았습니다",
    writeStrippedReadonly: "다음 필드는 읽기 전용이므로 저장되지 않았습니다: {{fields}}",
