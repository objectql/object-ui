const es = {
  ...
  detail: {
    ...
    inApprovalEditable: "En aprobación (editable)",
    inApprovalEditableTooltip: "Este registro tiene una solicitud de aprobación pendiente, pero este paso no lo bloquea: aún puede editarlo",
    writeStrippedTitle: "Algunos campos no se guardaron",
    writeStrippedReadonly: "De solo lectura, por lo que no se guardó: {{fields}}",
