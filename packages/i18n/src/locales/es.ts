const es = {
  ...
  grid: {
    ...
    import: {
      ...
      uploadDescription: "Cargue un archivo CSV para comenzar.",
      mappingDescription: "Asigne columnas CSV a los campos del objeto.",
      previewDescription: "Revise los datos antes de importar.",
      dragDrop: "Arrastre el archivo CSV aquí o haga clic para buscar",
