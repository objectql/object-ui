const pt = {
  ...
  list: {
    ...
    sortRelationalHint:
      "As colunas que apontam para outro registro não são listadas: elas só podem ser ordenadas pelo ID armazenado, não pelo nome exibido na célula. Para ordenar por esse nome, adicione um campo de fórmula que o contenha.",
    group: "Agrupar",
    groupBy: "Agrupar por",
    export: "Exportar",
    exportAs: "Exportar como {{format}}",
  ...
  detail: {
    ...
    writeStrippedTitle: "Alguns campos não foram salvos",
    writeStrippedReadonly: "Somente leitura, portanto não foi salvo: {{fields}}",
    writeStrippedByState: "Não editável no estado atual deste registro, portanto não foi salvo: {{fields}}",
    ...
    ai: {
      ...
      suggestions: {
        ...
        editApp: {
          ...
          addAutomation: "Adicione uma automação — uma aprovação, um fluxo de status ou uma notificação.",
        },
      },
