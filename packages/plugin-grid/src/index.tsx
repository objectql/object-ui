...
const GRID_QUERY_INPUTS: ComponentInput[] = [
  ...
  { name: 'searchableFields', type: 'array', description: 'Fields the toolbar search box queries. A non-empty list is what enables search — prefer it over the deprecated boolean `showSearch`, which cannot say WHICH fields to search.' },
