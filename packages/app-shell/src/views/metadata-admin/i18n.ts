...
const ENGINE_STRINGS_EN: Record<string, string> = {
  ...
  'engine.inspector.pageBlock.field.element:definition-list.items.label': 'Label',
  'engine.inspector.pageBlock.field.element:definition-list.items.value': 'Value',
  'engine.inspector.pageBlock.field.element:definition-list.columns': 'Columns (1 or 2)',
  'engine.inspector.pageBlock.field.element:definition-list.inline': 'Inline (label · value)',
...
const ENGINE_STRINGS_ZH: Record<string, string> = {
  ...
  'engine.inspector.pageBlock.field.element:definition-list.items.label': '标签',
  'engine.inspector.pageBlock.field.element:definition-list.items.value': '值',
  'engine.inspector.pageBlock.field.element:definition-list.columns': '列数（1 或 2）',
  'engine.inspector.pageBlock.field.element:definition-list.inline': '行内（标签 · 值）',
