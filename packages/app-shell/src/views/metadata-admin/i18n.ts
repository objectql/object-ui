...
const ENGINE_STRINGS_EN: Record<string, string> = {
  ...
  'engine.studio.data.badge.hooks': 'Lifecycle hooks · inventory',
  'engine.studio.data.badge.api': 'REST endpoints · reference',
  // API view
  'engine.studio.api.subtitle':
    'Auto-generated REST endpoints for this object, derived from its draft schema. Live execution and authentication live in the Developer console.',
  ...
  // Hooks view
  'engine.studio.hooks.explain':
    'Lifecycle hooks that fire on this object’s reads and writes. Hook logic is authored in code, so this is a read-only inventory.',
  'engine.studio.hooks.none': 'No hooks target this object.',
  'engine.studio.hooks.wildcard': 'all objects',
  'engine.studio.hooks.async': 'async',
  'engine.studio.hooks.condition': 'Runs when',
  'engine.studio.hooks.meta': 'priority {priority}',
  'engine.studio.hooks.code': 'logic in code',
...
const ENGINE_STRINGS_ZH: Record<string, string> = {
  ...
  'engine.studio.data.tab.api': 'API',
  'engine.studio.data.badge.hooks': '生命周期钩子 · 清单',
  'engine.studio.data.badge.api': 'REST 端点 · 参考',
  // API view
  'engine.studio.api.subtitle':
    '该对象自动生成的 REST 端点,依据其草稿 schema 派生。实时调用与身份验证在开发者控制台中进行。',
  ...
  // Hooks view
  'engine.studio.hooks.explain':
    '在该对象读写时触发的生命周期钩子。钩子逻辑以代码编写,此处为只读清单。',
  'engine.studio.hooks.none': '没有钩子作用于该对象。',
  'engine.studio.hooks.wildcard': '所有对象',
  'engine.studio.hooks.async': '异步',
  'engine.studio.hooks.condition': '触发条件',
  'engine.studio.hooks.meta': '优先级 {priority}',
  'engine.studio.hooks.code': '逻辑在代码中',
