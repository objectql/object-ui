        ...
        children: [
          {
            ...
            children: [
              {
                type: "text",
                content: "📍 Interactive Map with Location Markers",
                    ...
                    children: [
                      {
                        ...
                        gap: 1,
                        children: [
                          { type: "text", content: "📍 San Francisco Office", className: "font-semibold text-sm" },
                          { type: "text", content: "37.7749° N, 122.4194° W", className: "text-xs text-muted-foreground" }
                        ]
                      }
                    ]
                  },
                    ...
                    children: [
                      {
                        ...
                        gap: 1,
                        children: [
                          { type: "text", content: "📍 New York Office", className: "font-semibold text-sm" },
                          { type: "text", content: "40.7128° N, 74.0060° W", className: "text-xs text-muted-foreground" }
                        ]
                      }
                    ]
                  },
                    ...
                    children: [
                      {
                        ...
                        gap: 1,
                        children: [
                          { type: "text", content: "📍 London Office", className: "font-semibold text-sm" },
                          { type: "text", content: "51.5074° N, 0.1278° W", className: "text-xs text-muted-foreground" }
                        ]
                      }
                    ]
                  }
