...
<SchemaExample id="core-schema-renderer/schemarenderer-in-action" />

## Nested Schemas

The SchemaRenderer automatically handles nested schemas:

<SchemaExample id="core-schema-renderer/nested-schema-example" />
...
<SchemaExample id="core-schema-renderer/unknown-component-type" />
