---
title: "ObjectTable"
description: "Unified table component with ObjectQL integration, aligned with @objectstack/spec view.zod"
---

import { InteractiveDemo } from '@/app/components/InteractiveDemo';
import { ComponentDemo } from '@/app/components/ComponentDemo';

A specialized table component that automatically fetches and displays data from ObjectQL objects. Built on the data-table foundation and now **fully aligned with @objectstack/spec view.zod schema** for maximum interoperability.
...
- **View.zod Compliance**: Full compatibility with @objectstack/spec ListView schema

Inherits all data-table features: sorting, filtering, pagination, row selection, CSV export, column resizing, and reordering.

> **✨ New in v0.3**: ObjectTable now aligns with @objectstack/spec view.zod while maintaining full backward compatibility. See the [Migration Guide](/docs/plugins/plugin-object/object-table-migration) for details.
...
See the [Migration Guide](/docs/plugins/plugin-object/object-table-migration) for details on adopting new properties.
