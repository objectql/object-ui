---
title: "ObjectTable Migration Guide - view.zod Alignment"
description: "Guide for migrating ObjectTable schemas to align with @objectstack/spec view.zod"
---

# ObjectTable Migration Guide

## Overview

ObjectTable has been refactored to align with the `@objectstack/spec` view.zod schema while maintaining **full backward compatibility** with existing code. This guide explains the new features and shows how to gradually adopt them.
...
- [ObjectTable Documentation](/docs/plugins/plugin-object/object-table)
